...
import tt.richCabman.activities.FirstScreenActivity;
import tt.richCabman.activities.SignInActivity;
...
//        Logger.d("IMEI not null");
        ...
        if (!deviceIMEI.equals(user.getString("IMEI"))) {
            ...
            notification.sound = Uri.parse("android.resource://tt.richCabman/raw/notification");
