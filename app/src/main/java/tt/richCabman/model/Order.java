...
public class Order implements Parcelable {
    public static final String ORDER_KEY = "tt.richCabman.model.Order.KEY";
    public static final String PARAM_DISTANCE = "tt.richCabman.model.Order.DISTANCE";
    public static final String PARAM_TRAVEL_TIME = "tt.richCabman.model.Order.TRAVEL_TIME";
